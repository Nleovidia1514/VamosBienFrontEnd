...
class Slider extends Component {
  ...
  state = {
    ...
    sliderStates: [
      {
        link: '/Promotions',
        image: '/Airport/Assets/Images/prom1.jpg',
        isCurrent: true,
        id: 0,
        title: 'Promotions'
      },
      {
        link: '/Promotions',
        image: '/Airport/Assets/Images/prom2.jpg',
        isCurrent: false,
        id: 1,
        title: 'Promotions'
      },
      {
        link: '/Explore',
        image: '/Airport/Assets/Images/prom3.jpg',
        isCurrent: false,
        id: 2,
        title: 'Explore'
      },
      {
        link: '/Flights',
        image: '/Airport/Assets/Images/prom4.jpg', //aerial-aerial-view-aeroplane-59519.jpg
        isCurrent: false,
        id: 3,
        title: 'Flights'
      }
